...
CREATE TABLE `recipe` (
  ...
  `Createdat` timestamp NOT NULL DEFAULT current_timestamp(),
  `Sterren` enum('Beginner ☆☆☆','Makkelijk ⭐☆☆','Gemiddeld ⭐⭐☆','Moeilijk ⭐⭐⭐') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
